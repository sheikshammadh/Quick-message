...
const Sidebar = ({selectedUser,setselectedUser}) => {
  ...
  return (
    <div className={`bg-[#8185B2]/10 h-full p-5 rounded-r-xl overflow-y-scroll text-white ${selectedUser ? 'max-md:hidden' : ''}`}>
      <div className='pb-5'>
        <div className='flex justify-betweeen items-centre'>
        ...
        <div className='bg-[#282142] rounded-full flex items-center gap-2'>
            ...
            <input type="text" name="bg-transparent border-none outline-none text-white text-xs placeholder-[#c8c8c8] flex-1" placeholder='Search User...'/>
        </div>
      </div>
    </div>
  )
