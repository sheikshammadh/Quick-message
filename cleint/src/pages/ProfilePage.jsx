...
const ProfilePage = () => {
  ...
  const[bio,setBio]=useState("Hello...Iam using Quick chat.")
      ...
      rounded-1g'>
        <form className="flex flex-col gap-5 p-10 flex-1">
          ...
          cursor-pointer'>
            ...
            <img src={selctedimage ? URL.createObjectURL(selctedimage) : assets.avatar_icon} alt="" className={`w-12 h-12 ${selctedimage && 'rounded-full'}`}/>
